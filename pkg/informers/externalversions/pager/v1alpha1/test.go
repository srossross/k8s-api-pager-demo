...
import (
	...
	v1alpha1 "github.com/srossross/k8s-test-runner/pkg/listers/pager/v1alpha1"
	...
	sharedIndexInformer := cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				return client.PagerV1alpha1().Tests(v1.NamespaceAll).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				return client.PagerV1alpha1().Tests(v1.NamespaceAll).Watch(options)
			},
		},
		&pager_v1alpha1.Test{},
		resyncPeriod,
