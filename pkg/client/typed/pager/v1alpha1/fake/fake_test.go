...
var testsResource = schema.GroupVersionResource{Group: "pager.k8s.co", Version: "v1alpha1", Resource: "tests"}

var testsKind = schema.GroupVersionKind{Group: "pager.k8s.co", Version: "v1alpha1", Kind: "Test"}
