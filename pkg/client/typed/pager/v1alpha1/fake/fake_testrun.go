...
var testrunsResource = schema.GroupVersionResource{Group: "pager.k8s.co", Version: "v1alpha1", Resource: "testruns"}

var testrunsKind = schema.GroupVersionKind{Group: "pager.k8s.co", Version: "v1alpha1", Kind: "TestRun"}
